...
},{"./Game":1,"./GameTime":2,"./prefabs":18,"./psycho":23,"./reqAnimFrame":33}],5:[function(require,module,exports){
...
module.exports = psycho.Collection.extend({
  ...
  initialize: function(){
    this.entities = [];
    this.pos = psycho.Vector.prod(this.pos, config.size);
  ...
  createIcons: function(){
    ...
    this.iconAlives = new psycho.Sprite(spider);
    ...
    this.iconKills = new psycho.Sprite(spider);
    this.entities.push(this.iconKills);
    
    this.lineAKills = new psycho.Line({
      pos: psycho.Vector.origin(spider.pos, spSize),
      to: psycho.Vector.add(hSpSize, spider.pos),
      size: 3,
      color: this.colors.kills
    });
    this.entities.push(this.lineAKills);

    this.lineBKills = new psycho.Line({
  ...
  createText: function(){
    ...
    this.textKills = new psycho.Text({
    ...
    this.textAlives = new psycho.Text({
...
},{"./Controls":5,"./Cursor":6,"./Element":7,"./Elements":8,"./Node":9,"./Nodes":10,"./Path":11,"./Paths":12,"./Spider":13,"./Spiders":14,"./Stats":15,"./Target":16,"./Vacuum":17}],19:[function(require,module,exports){
...
var psycho = window.psycho = {};

psycho.Base = require("./Base");

psycho.Entity = require("./Entity");
psycho.Collection = require("./Collection");

psycho.Mathf = require("./util/Mathf");
psycho.Color = require("./util/Color");
psycho.Vector = require("./util/Vector");
psycho.Renderer = require("./util/Renderer");
psycho.Repo = require("./util/Repo");

psycho.Circle = require("./shapes/Circle");
psycho.Line = require("./shapes/Line");
psycho.Rect = require("./shapes/Rect");
psycho.Text = require("./shapes/Text");

psycho.Sprite = require("./Sprite");

},{"./Base":19,"./Collection":20,"./Entity":21,"./Sprite":22,"./shapes/Circle":24,"./shapes/Line":25,"./shapes/Rect":26,"./shapes/Text":27,"./util/Color":28,"./util/Mathf":29,"./util/Renderer":30,"./util/Repo":31,"./util/Vector":32}],24:[function(require,module,exports){
